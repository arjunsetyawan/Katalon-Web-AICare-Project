...
WebUI.click(findTestObject('Manage Medicine/Medicine/button_Show'))

WebUI.verifyElementPresent(findTestObject('Manage Medicine/Medicine/div_detail'), 0)

WebUI.delay(1)

WebUI.click(findTestObject('Manage Medicine/Medicine/icon_silang'))
