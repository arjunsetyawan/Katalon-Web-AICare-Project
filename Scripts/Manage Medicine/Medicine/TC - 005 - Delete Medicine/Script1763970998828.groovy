...
WebUI.click(findTestObject('Manage Medicine/Medicine/button_Delete'))

WebUI.delay(1)

WebUI.click(findTestObject('Manage Medicine/Medicine/button_Cancel'))
...
WebUI.click(findTestObject('Manage Medicine/Medicine/button_KonfirmDelete'))
