...
WebUI.click(findTestObject('Manage Medicine/Medicine Categories/button_Add New Category'))

WebUI.click(findTestObject('Manage Medicine/Medicine Categories/input_Name'))

WebUI.setText(findTestObject('Manage Medicine/Medicine Categories/input_Name'), 'Demam')

WebUI.delay(1)

WebUI.click(findTestObject('Manage Medicine/Medicine Categories/input_Status Active'))

WebUI.click(findTestObject('Manage Medicine/Medicine Categories/button_Save'))
