...
WebUI.click(findTestObject('Manage Medicine/Medicine Categories/button_Delete'))

WebUI.delay(1)

WebUI.click(findTestObject('Manage Medicine/Medicine Categories/button_Cancel'))
...
WebUI.click(findTestObject('Manage Medicine/Medicine Categories/button_konfirmDelete'))
