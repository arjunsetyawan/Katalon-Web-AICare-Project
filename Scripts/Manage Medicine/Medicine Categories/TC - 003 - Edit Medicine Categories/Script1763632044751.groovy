...
WebUI.click(findTestObject('Manage Medicine/Medicine Categories/button_Edit'))

WebUI.click(findTestObject('Manage Medicine/Medicine Categories/input_Name'))

WebUI.setText(findTestObject('Manage Medicine/Medicine Categories/input_Name'), 'Diabetes')

WebUI.delay(1)

WebUI.click(findTestObject('Manage Medicine/Medicine Categories/input_status Inactive'))
