...
WebUI.click(findTestObject('Doctor Management_Page/Pricing/button_Delete'))

WebUI.delay(1)

WebUI.click(findTestObject('Doctor Management_Page/Pricing/button_Cancel Delete'))
...
WebUI.click(findTestObject('Doctor Management_Page/Pricing/button_Deletekonfirm'))
