...
WebUI.click(findTestObject('Discussion/button_Delete'))

WebUI.delay(1)

WebUI.click(findTestObject('Discussion/button_Cancel Delete'))
...
WebUI.click(findTestObject('Discussion/button_KonfirmDelete'))
