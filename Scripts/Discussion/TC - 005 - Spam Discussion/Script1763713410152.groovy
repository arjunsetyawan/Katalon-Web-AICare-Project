...
WebUI.click(findTestObject('Discussion/button_Spam'))

WebUI.delay(1)

WebUI.click(findTestObject('Discussion/button_Cancel Spam'))
...
WebUI.click(findTestObject('Discussion/button_Yes Spam'))
