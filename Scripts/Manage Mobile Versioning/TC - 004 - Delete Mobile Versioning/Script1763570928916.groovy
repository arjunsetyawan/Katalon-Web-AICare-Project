...
WebUI.click(findTestObject('Manage Mobile Versioning/button_Delete'))

WebUI.delay(1)

WebUI.click(findTestObject('Manage Mobile Versioning/button_Cancel'))
...
WebUI.click(findTestObject('Manage Mobile Versioning/button_konfirmDelete'))
