...
WebUI.click(findTestObject('Health Facility/button_Delete'))

WebUI.delay(1)

WebUI.click(findTestObject('Health Facility/button_Cancel'))
...
WebUI.click(findTestObject('Health Facility/button_KonfirmDelete'))
