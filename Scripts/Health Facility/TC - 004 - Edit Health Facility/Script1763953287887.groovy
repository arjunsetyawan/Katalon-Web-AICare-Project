...
WebUI.click(findTestObject('Health Facility/a_Edit'))

WebUI.click(findTestObject('Health Facility/input_Name'))

WebUI.setText(findTestObject('Health Facility/input_Name'), 'RS Test 123')
...
WebUI.setText(findTestObject('Health Facility/input_region'), 'Tangerang')

WebUI.delay(1)

WebUI.click(findTestObject('Health Facility/input_city'))

WebUI.setText(findTestObject('Health Facility/input_city'), 'Tangerang Selatan')

WebUI.delay(1)

WebUI.click(findTestObject('Health Facility/input_district'))

WebUI.setText(findTestObject('Health Facility/input_district'), 'Karawaci')
...
WebUI.setText(findTestObject('Health Facility/textarea_Address'), 'Jalan Kober Kecil 70')

WebUI.delay(1)

WebUI.click(findTestObject('Health Facility/textarea_Description'))

WebUI.setText(findTestObject('Health Facility/textarea_Description'), 'Testingg123')
...
WebUI.setText(findTestObject('Health Facility/input_Phone Number'), '08634525621')

WebUI.delay(1)

WebUI.click(findTestObject('Health Facility/input_BPJS_No'))

WebUI.click(findTestObject('Health Facility/input_status_inactive'))
