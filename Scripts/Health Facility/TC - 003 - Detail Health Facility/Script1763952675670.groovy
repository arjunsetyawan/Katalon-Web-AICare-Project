...
WebUI.click(findTestObject('Health Facility/button_Show'))

WebUI.delay(1)

WebUI.verifyElementPresent(findTestObject('Health Facility/div_Health Facility Details'), 
    0)

WebUI.delay(1)

WebUI.click(findTestObject('Health Facility/icon_silang'))
