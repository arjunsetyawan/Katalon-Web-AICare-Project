...
WebUI.click(findTestObject('Gimmick History/a_View'))

WebUI.delay(1)

WebUI.verifyElementPresent(findTestObject('Gimmick History/div_profil'), 0)

WebUI.delay(1)

WebUI.verifyElementPresent(findTestObject('Gimmick History/div_conclusion'), 0)
