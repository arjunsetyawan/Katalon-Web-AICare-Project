...
WebUI.click(findTestObject('Doctor Specialty_Page/button_Add New Specialty'))

WebUI.click(findTestObject('Doctor Specialty_Page/input_Name_name'))

WebUI.setText(findTestObject('Doctor Specialty_Page/input_Name_name'), 'Spesialis Tes')

WebUI.click(findTestObject('Doctor Specialty_Page/input_Tag_tag'))

WebUI.setText(findTestObject('Doctor Specialty_Page/input_Tag_tag'), 'Olahraga')
...
WebUI.click(findTestObject('Doctor Specialty_Page/input_status active'))
