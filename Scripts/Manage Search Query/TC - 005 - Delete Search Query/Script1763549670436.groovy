...
WebUI.click(findTestObject('Manage Search Query/button_Delete'))

WebUI.delay(1)

WebUI.click(findTestObject('Manage Search Query/button_Cancel'))
...
WebUI.click(findTestObject('Manage Search Query/button_konfirmDelete'))
