...
WebUI.click(findTestObject('Manage Search Query/button_View'))

WebUI.verifyElementPresent(findTestObject('Manage Search Query/pop up_detail'), 0)

WebUI.delay(2)

WebUI.click(findTestObject('Manage Search Query/icon_silang'))
