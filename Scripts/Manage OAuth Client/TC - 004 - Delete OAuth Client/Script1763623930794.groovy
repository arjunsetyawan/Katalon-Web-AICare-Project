...
WebUI.click(findTestObject('Manage OAuth Client/button_Delete'))

WebUI.delay(1)

WebUI.click(findTestObject('Manage OAuth Client/button_CancelDelete'))
...
WebUI.click(findTestObject('Manage OAuth Client/button_konfirmDelete'))
